...
%             [dc,dc_u,dc_sig] = obj.computeParametersGradient(s0,sec,'finite differences',1);
            dc = load('dcAltDir.mat', 'dc').dc;
        ...
        function [dC, dV1, dV2] = calculateFiniteGradient(obj, s)
            ...
            for i = 1:numel(s)
                ...
                [cu, v1_u, v2_u] = ISCSO_2022(x1,0);
                [cl, v1_l, v2_l] = ISCSO_2022(x2,0);
                ds = 1/37;
                dCu(i)   = (cu-c0) / (ds);
                dV1_u(i) = (v1_u-v10) / (ds);
                dV2_u(i) = (v2_u-v20) / (ds);
